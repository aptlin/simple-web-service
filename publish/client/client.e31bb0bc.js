...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function updateInfo(user) {
  if (user.username) {
    ...
    var _searchStatus = document.getElementById("search-status");

    _searchStatus.classList.toggle("is-hidden", false);

    var _info = document.getElementById("info");

    _info.classList.toggle("is-hidden", true);
  }
}
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get("/by-id?id=".concat(id));
...
function _findByUsername() {
  _findByUsername = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _axios.default.get("/by-login?login=".concat(id));
...
function setup() {
  var searchByIDButton = document.getElementById("search-by-id");
  var searchByIDTerm = document.getElementById("id-search-term");

  searchByIDButton.onclick = function () {
    return findByID(searchByIDTerm.value);
  };

  var searchByUsernameButton = document.getElementById("search-by-username");
  var searchByUsernameTerm = document.getElementById("username-search-term");

  searchByUsernameButton.onclick = function () {
    return findByUsername(searchByUsernameTerm.value);
  };
}

window.onload = setup;
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","axios":"../node_modules/axios/index.js","bulma/css/bulma.css":"../node_modules/bulma/css/bulma.css"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
